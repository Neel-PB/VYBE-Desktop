...
export function renderTabTab(parent: HTMLElement): void {
	...
	const mainSectionList = mainSection.querySelector('.vybe-settings-section-list') as HTMLElement;
	const mainSubSection = DOM.append(mainSectionList, DOM.$('.vybe-settings-sub-section'));
	...
	const partialAcceptsLabel = partialAcceptsCell.querySelector('.vybe-settings-cell-label') as HTMLElement;
	...
	const autoImportLabel = autoImportCell.querySelector('.vybe-settings-cell-label') as HTMLElement;
	if (autoImportLabel) {
	...
	const subSectionTrailingCaption = DOM.append(mainSubSection, DOM.$('.vybe-settings-sub-section-trailing-caption'));
