...
export function renderAgentsTab(parent: HTMLElement): void {
	...
	chatComposerSection.id = 'vybe-settings-chat-composer';
	const chatComposerSectionList = chatComposerSection.querySelector('.vybe-settings-section-list') as HTMLElement;
	const chatComposerSubSection = DOM.append(chatComposerSectionList, DOM.$('.vybe-settings-sub-section'));
	...
	const agentReviewSectionList = agentReviewSection.querySelector('.vybe-settings-section-list') as HTMLElement;
	const agentReviewSubSection = DOM.append(agentReviewSectionList, DOM.$('.vybe-settings-sub-section'));
	agentReviewSubSection.id = 'vybe-settings-agent-review';
	...
	const contextSectionList = contextSection.querySelector('.vybe-settings-section-list') as HTMLElement;
	const contextSubSection = DOM.append(contextSectionList, DOM.$('.vybe-settings-sub-section'));
	...
	const applyingChangesSectionList = applyingChangesSection.querySelector('.vybe-settings-section-list') as HTMLElement;
	const applyingChangesSubSection = DOM.append(applyingChangesSectionList, DOM.$('.vybe-settings-sub-section'));
	...
	const autoRunSectionList = autoRunSection.querySelector('.vybe-settings-section-list') as HTMLElement;
	const autoRunSubSection = DOM.append(autoRunSectionList, DOM.$('.vybe-settings-sub-section'));
	...
	const inlineEditingSectionList = inlineEditingSection.querySelector('.vybe-settings-section-list') as HTMLElement;
	const inlineEditingSubSection = DOM.append(inlineEditingSectionList, DOM.$('.vybe-settings-sub-section'));
	...
	const voiceModeSectionList = voiceModeSection.querySelector('.vybe-settings-section-list') as HTMLElement;
	const voiceModeSubSection = DOM.append(voiceModeSectionList, DOM.$('.vybe-settings-sub-section'));
